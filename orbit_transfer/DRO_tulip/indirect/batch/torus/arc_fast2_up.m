%% ARC_FAST2_up  Pseudo-arclength continuation of the NEW fast family (anchor
% at sA 0.8671, 17.25 d) in the up arrival direction, recording crossings of
...
ao.logFile = fullfile(ind, 'results', 'arrival_arc_fast2_up_long.log');
t0 = tic;
A = arclength_arrival(anc, ao);
save(fullfile(ind, 'results', 'arrival_arc_fast2_up_long.mat'), 'A', '-v7.3');
fprintf('ARC fast2 up DONE: %d roots, sA %.4f -> %.4f, %d folds, %d crossings, stop = %s (%.0f s)\n', ...
