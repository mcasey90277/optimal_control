...
**Files:**
- Create: `earth_elliptic_to_geo/psr_mee_refine.m` (port `NLP_lowThrust_GTO_tulip/PSR/` PMP-Steered Refinement — switching-function zeros steer mesh insertion — to the MEE solver).
