...
``specified in full and never implemented'' --- was written. Recounted on
9 August 2026 it is 59, 28 and 25: the closed-loop guidance spike added
\code{+coorbital/+guide/terminalConstraint.m} and its test. Note that
\code{docs/README.md}'s conventions section still says ``39 \code{.m} files'';
...
\code{missVector} --- and \code{tests/test\_runBallisticTarget.m}. Every
