...
%% ENTRY and TERMINUS, not launch and impact. This script begins at an entry
%% interface and ends at a terminal altitude; neither is a pad and neither is
%% the ground, and the ground track must not claim otherwise:
