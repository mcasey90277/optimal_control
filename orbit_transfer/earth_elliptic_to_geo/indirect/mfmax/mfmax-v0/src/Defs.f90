...
! Integer parameter
integer, parameter :: lipar = 2  ! At least 1
...
real (kind=8), parameter :: arcre = 1.d-5
real (kind=8), parameter :: arcae = 1.d-5
! Required precision after zero path tracking
real (kind=8), parameter :: ansre = 1.e-8
real (kind=8), parameter :: ansae = 1.e-8
