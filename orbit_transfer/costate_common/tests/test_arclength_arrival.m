...
%   doc/algorithms_orbit_transfer.tex section 2.1. A local function of this
%   test since 2026-09-16: the test's oracle was its only consumer
%   (costate_common cleanup step 5).
%
%% Inputs:
%
%  x                        [6 x 1]                 [r; v]
