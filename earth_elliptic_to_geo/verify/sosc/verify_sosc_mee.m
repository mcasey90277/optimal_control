...
% OUTPUTS:
%   sosc - struct per process/DESIGN_sosc.md sec 11.4-11.6 (.verdict .reason
%          .status .drift .sign .kkt .active .inertia .red .nFlat .redMinEig
%          .method .robust .thresholds .meta)
% REFERENCES: process/DESIGN_sosc.md secs 4-5, 11.4-11.6.
