...
separates a converged NLP from an answer. One \emph{negative} result recurs
...
\emph{five} significant figures, not six. And it is agreement on $t_f$ and on
the endpoints---which the boundary conditions pin in any case; a genuine
trajectory-level comparison, of the state and control histories or of the mapped
costates against \code{tfMin}'s, has not been made. That comparison is this
campaign's actual objective, and it is now unblocked rather than completed.
