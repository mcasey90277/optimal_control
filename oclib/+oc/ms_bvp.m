...
%
%   The arc is split into K segments whose junction states are extra
%   unknowns; short segments kill the Lyapunov amplification that makes
%   single shooting from approximate seeds intractable (measured on the
%   CR3BP min-time problem: collocation seeds miss by 36,000-560,000 km
...
%  M. Casey  promoted to oclib/+oc (second top-level consumer)  (c) 09/16/2026
