...
\begin{itemize}
  \item \textbf{Certified tulip solution} ($1.15\times$ legacy scale $=1.24\times$
    ...
    \item \textbf{Tulip $\Delta V$--$t_f$ front}: certified band $1.12$--$1.25\times$
        ...
        $\Delta V$). Free rows are converged with raw-dual primer alignment
        $\le0.12^\circ$; the first-order gate on the 9-state layout is still
        to be run before the word ``certified'' attaches to them. Switch count grows/shrinks with
