...
and the Sundman law $\ud t/\ud\tau = \kappa = r_1^{\,p}$, a uniform $\sigma$
grid of spacing $\Delta\sigma = 1/N$ gives physical time steps
\begin{equation}
\Delta t_k \;\simeq\; \tau_f\,\kappa(\vect{x}_k)\,\Delta\sigma
\;=\; \frac{\tau_f}{N}\, r_1(\vect{x}_k)^{p} ,
\qquad p = \tfrac{3}{2}.
\label{eq:dtk}
\end{equation}
