...
are the free-$\tau_f$ ones. The honest fix in the engine is the sparse slack
state, which keeps the KKT matrix banded and is already what the min-time
anchor and the thrust ladder use.
