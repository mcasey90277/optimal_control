...
\begin{itemize}
  ...
  \item \textbf{Tulip $\Delta V$--$t_f$ front}: certified band $1.12$--$1.25\times$
        ...
        target-consistent; campaign-best $\Delta V=2.434$~km/s at $1.65\times$
        legacy $=1.78\times$ (46~d, $\sim$45\% below the legacy min-time
        $\Delta V$ of 4.4665~km/s; recompute against the 5.8267~ND anchor's own
        $\Delta V$). Switch count grows/shrinks with
