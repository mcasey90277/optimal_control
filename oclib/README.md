...
3. ~~(part) local-residual engine~~ — `oc.local_residual` landed 2026-08-25
   ...
   landed 2026-09-17: the cart-pole study scripts (`optimal_control_examples`,
   cart-pole sub-project A Task 4) are its second TOP-LEVEL consumer, calling
