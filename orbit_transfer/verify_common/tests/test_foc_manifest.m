...
names = {'earth_mee','earth_cr3bp','tulip','tulip_free','elfo_fuel','elfo_mintime','toy'};
...
m = foc_manifest('tulip_free');  assert(m.nx==9 && m.massRow==7 && m.timeRow==8 && strcmp(m.horizonKind,'freetf-cscale'));
