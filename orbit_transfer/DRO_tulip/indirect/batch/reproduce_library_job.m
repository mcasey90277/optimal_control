%% REPRODUCE_LIBRARY_JOB  The detached job that rebuilds the 70 mN DRO -> tulip
...
verdictF = fullfile(getenv('HOME'), 'REPRODUCE_VERDICT.txt');
opts = struct('go', true);                       % add 'outDir', 'nWorkers', ... as needed
