      subroutine rkf45(LAMBDA,f,neqn,y,t,tout,relerr,abserr,
     &                           iflag,work,iwork)
...
c
      call rkfs(LAMBDA,f,neqn,y,t,tout,relerr,abserr,iflag,work(1),
     1          work(k1m),work(k1),work(k2),work(k3),work(k4),work(k5),
     2          work(k6),
     3          work(k6+1),iwork(1),iwork(2),iwork(3),iwork(4),iwork(5))
c
      return
      end
       subroutine rkfs(LAMBDA,f,neqn,y,t,tout,relerr,abserr,
     1   iflag,yp,h,f1,f2,f3,f4,f5,savre,savae,nfe,kop,
     2   init,jflag,kflag)
c
c     fehlberg fourth-fifth order runge-kutta method
c
...
c
  220 call fehl(LAMBDA,f,neqn,y,t,h,yp,f1,f2,f3,f4,f5,f1)
      nfe=nfe+5
c
...
c
      ...
      subroutine fehl(LAMBDA,f,neqn,y,t,h,yp,f1,f2,f3,f4,f5,s)
c
c     fehlberg fourth-fifth order runge-kutta method
c
