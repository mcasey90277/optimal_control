...
ok = chk(ok, out2.atFinal && out2.nInterior == 0 && strcmp(out2.verdict, 'ENDPOINT') && ~out2.pass, ...
         sprintf('the same with the final sign untrusted -> ENDPOINT (atFinal=%d nInterior=%d verdict=%s)', ...
                 out2.atFinal, out2.nInterior, out2.verdict));
