%% FILL_HOLES_JOB (improve pass, 2 d)  Cell-by-cell direct solves at every hole of the round-6
...
out = fill_holes_direct(fullfile(ind, 'results_fine_v6', 'costate_catalog_dro_tulip_70mN.mat'), ...
    struct('logFile', fullfile(ind, 'results_fine_v6', 'fill_holes_direct.log'), 'clearKm', 1900, 'improveDays', 2));
