...
%
%   PROMOTED 2026-09-17 out of orbit_transfer/costate_common into the
%   cross-folder library, call it as oc.ms_conjugate_test: the cart-pole
%   study scripts (optimal_control_examples) are its second TOP-LEVEL
%   consumer, which is what the admission rule asks for. A delegate stays
%   at the old path so every costate_common caller works unchanged.
%
...
%  M. Casey  promoted to oclib/+oc (second top-level consumer)  (c) 09/17/2026
